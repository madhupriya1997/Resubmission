    ...
    $("#load").css('display','none');
     ...
     /*  var gurl = url.child(get.pid);
       ...
       // {
            ...
            document.getElementById('p'+i).innerHTML = "<strong>"+get.title + "<br/>" + get.shortDescription + "</strong>AUTHOR :" + get.author + "<br/> <i class='fas fa-calendar-alt' style='color:grey;font-size:15px;'>"+get.date+"</i>";
